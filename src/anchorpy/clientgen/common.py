...
_GENERATED_FILE_HEADER = (
    "# This code was AUTOGENERATED using the anchor-py library.\n"
    "# Please DO NOT EDIT THIS FILE\n"
)


def _add_generated_file_header(code: str) -> str:
    if code.startswith(_GENERATED_FILE_HEADER):
        return code
    return f"{_GENERATED_FILE_HEADER}\n{code}"
...
def _bytes_literal(data: Sequence[int] | bytes) -> str:
    ...
    rendered = "".join([f"\\x{b:02x}" for b in bytes(data)])
    return f'b"{rendered}"'
